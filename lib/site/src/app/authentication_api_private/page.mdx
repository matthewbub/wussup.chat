...
<Row>
  <Col>
    ...
    <CodeGroup title="Logout request examples">
...
<Row>
  <Col>
    ...
    <Properties>
      ...
      <Property name="newPassword" type="string">
        New password. Must meet password strength requirements: 8-20 characters with at least one uppercase letter, lowercase letter, number, and special character (!@#$%^&*).
      </Property>
    </Properties>
  ...
  <Col>
    ...
    <CodeGroup title="Change password request examples">
...
<Row>
  <Col>
    ...
    <CodeGroup title="Get user info request examples">
...
<Row>
  <Col>
    ...
    <Properties>
      <Property name="email" type="string" optional>
        New email address. Must be unique and will require verification.
      </Property>
      <Property name="username" type="string" optional>
        New username. Must be unique and 3-255 characters.
      </Property>
    </Properties>
  ...
  <Col>
    ...
    <CodeGroup title="Update profile request examples">
...
<Row>
  <Col>
    ...
    <CodeGroup title="Delete account request examples">
