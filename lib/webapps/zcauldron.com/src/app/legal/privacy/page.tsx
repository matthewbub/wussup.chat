...
1. You ask us to delete the information by sending a request to support@ninembs.studio. Please note that such requests may result in you no longer being able to access paid or free content previously provided to you.
...
State consumer privacy laws in the U.S. may give their residents additional rights regarding how we use their personal information. These privacy rights vary depending on the local laws that apply to you. Depending on the state including but not limited to California, Colorado, Connecticut, Virginia, Iowa, Texas, Delaware, Nebraska, New Hampshire, Nevada, New Jersey, Tennessee, Minnesota, Maryland, Utah, and others, you may be subject to the following rights:

- The right to obtain confirmation of processing and access to your data.
- The right to correct incomplete or inaccurate data.
- The right to portability of data where you can request your data to be transferred to another organization.
- The right to revoke or withdraw consent at any time.
- The right to delete your personal information/data collected from you, subject to certain limitations under the law. 
- The right to opt out of the sale or sharing of your personal information.
- The right to non-discrimination for exercising a privacy right.
- The right to obtain a list of third parties to which personal information was shared or disclosed. 
- The right to limit the use and disclosure of sensitive personal information. 

**California, Colorado, Connecticut, Virginia, Iowa, Delaware, Nebraska, New Hampshire, New Jersey, Tennessee, Minnesota, Maryland, Utah, Texas, and other states provide their state residents with rights to:**
...
**Several states including but not limited to California, Colorado, Connecticut, Nebraska, Delaware, Texas, New Hampshire, New Jersey, Minnesota, Maryland, and Virginia also provide their state residents with rights to:**
...
**Maryland** prohibits the sale of personal information requiring that sensitive data can only be processed to provide a requested service or product. 

To exercise any of these rights above under different states, please contact us with your request at support@ninembs.studio and please include your name, email address, and mailing address. 
...
- You have the right to opt out of the sale and sharing of your personal information with third parties. If you are under the age of 16, you have the right to opt into such sales or to have a parent or guardian opt-in on your behalf.
...
- You have the right to data portability and the right to request your personal information and use it for your own purposes.
