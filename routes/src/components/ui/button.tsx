...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-stone-950 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 dark:focus-visible:ring-stone-300",
  {
    variants: {
      variant: {
        default:
        ...
        primary:
          "bg-teal-500 text-stone-50 shadow-sm hover:bg-teal-500/90 dark:bg-teal-900 dark:text-stone-50 dark:hover:bg-teal-900/90",
        destructive:
